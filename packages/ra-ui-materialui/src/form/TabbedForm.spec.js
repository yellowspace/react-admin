...
describe('<TabbedForm />', () => {
    it('should display <Toolbar />', () => {
        ...
        const toolbar = wrapper.find('WithWidth(WithStyles(Toolbar))');
    ...
    it('should pass submitOnEnter to <Toolbar />', () => {
        ...
        const button1 = wrapper1.find('WithWidth(WithStyles(Toolbar))');
        ...
        const button2 = wrapper2.find('WithWidth(WithStyles(Toolbar))');
